...
export const MessageCircle: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
...
export const Bookmark: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
...
export const DislikeIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
...
export const CheckCircle: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
