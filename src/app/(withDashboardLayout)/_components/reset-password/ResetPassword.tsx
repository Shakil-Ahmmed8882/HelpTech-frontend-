...
const ResetPasswordPage = () => {
  ...
  return (
    <section className="mt-14 p-8">
      <HTForm resolver={zodResolver(resetPasswordSchema)} onSubmit={handleResetPassword}>
            <div className=" sm:w-1/2 mx-auto space-y-6 ">
            <HTInput name="newPassword" label="New Password" type="text"/>
            <Button type="submit" className={'bg-primaryColor w-full text-white'}>Save</Button>
            </div>
